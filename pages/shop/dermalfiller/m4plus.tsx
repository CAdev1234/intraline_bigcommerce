...
export default function M4Plus() {
    ...
    const [numM4Plus, setNumM4Plus] = useState(1)
    
    const dispatch = useAppDispatch()
    const addToBagHandler = () => {
        dispatch(addProductToCart({title: 'M4 Plus', amount: numM4Plus, price: 100, img: '/assets/img/products/m4plus.png'}))
    }
    const decreaseNumHandler = () => {
        if (numM4Plus > 1) {
            setNumM4Plus(numM4Plus - 1)
        }else {
            setNumM4Plus(1)
        }
    }
        ...
        <div className="ttcommon_font_thin text-c_00080D flex flex-col">
                    ...
                    <div className="flex my-auto w-full">
                        <div className="w-6/12 flex flex-col pl-15">
                            <div className="mt-28">
                                ...
                                <div className="ttcommon_font_thin text-200px leading-200_160 font-semibold mt-7" ><span className="ttcommon_font_bold">M4</span> Plus</div>
                                ...
                                {logined && <div className="mt-5 flex items-center h-11 text-white">
                                    <div className="bg-c_00080D flex items-center justify-center w-24 h-full">
                                        ...
                                        <div className="mx-auto">{numM4Plus}</div>
            ...
            <div className="bg-white px-40">
                <div className="flex flex-col max-w-2xl mx-auto py-28">
                    ...
                    <p className="leading-36_48 mt-6 text-4xl ttcommon_font_thin text-center">M4 Plus with lidocaine is best suited for treatment of fine to medium wrinkles in the frown lines, cupid’s bow, labial commissure, neck folds and lip definition.</p>
                    <div className="mt-8">
