                        ...
                        <div className="flex flex-col
                            ...
                            <div className="mt-0 md:mt-28">
                                ...
                                <div className="ttcommon_font_thin leading-200_160 font-semibold mt-7
                                                text-7xl sm:text-8xl md:text-8xl lg:text-9xl xl:text-200px" ><span className="ttcommon_font_bold">M3</span> Plus</div>
            ...
            <div className="bg-white">
                <div className="flex flex-col mx-auto py-28
                    ...
                    <p className="leading-36_48 mt-6 ttcommon_font_thin text-center
                                text-2xl md:text-4xl">M3 Plus with lidocaine is best suited for treatment of fine to medium wrinkles in the frown lines, cupid’s bow, labial commissure, neck folds and lip definition.</p>
                    <div className="mt-8">
