...
export default function Dimension720() {
    ...
    const renderPDOThreads = () => {
        ...
        return items.map((item, index) => {
            return <div className="flex flex-col pt-9 pb-12_5 bg-white relative hover:bg-opacity-50" 
                        ...
                        <div className="ttcommon_font_bold mt-5 uppercase text-center text-color_1 tracking-widest text-2xl">Dimension 720</div>
    ...
    const addToBagHandler = () => {
        dispatch(addProductToCart({title: 'Dimension 720 PDO', amount: numDimension720, price: 100, img: '/assets/img/products/lifting_dimension720.png'}))
    }
