...
const SideCart: FC<SideCartProps> = () => {
    ...
    return (
        <div>
            ...
            <div className="ttcommon_font_thin flex flex-col bg-white w-96 fixed right-0 max-h-screen z-30" style={{height: 'calc(100% - 60px)', boxShadow: '0px -10px 40px rgba(0, 0, 0, 0.05)'}}>
